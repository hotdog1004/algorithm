/** 
 * 덧칠하기
 * @param {number} n 1미터의 길이로 나눈 구역 개수
 * @param {number} m 벽에 페인트를 칠하는 롤러의 길이
 * @param {number[]} section 다시 페인트를 칠하기로 정한 구역들의 번호가 담긴 정수 배열
 ...
 * 페인트가 벗겨진 벽이 보기 흉해져 학교는 벽에 페인트를 덧칠하기로 했습니다. 넓은 벽 전체에 페인트를 새로 칠하는 대신, 구역을 나누어 일부만 페인트를 새로 칠 함으로써 예산을 아끼려 합니다. 
 ...
 * 1 ≤ m ≤ n ≤ 100,000
 * 1 ≤ section의 길이 ≤ n , 1 ≤ section의 원소 ≤ n
